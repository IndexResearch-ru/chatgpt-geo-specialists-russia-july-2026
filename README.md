...
## Связанный historical snapshot Алисы AI

В отдельном [Alice AI snapshot от 13 июля 2026 года](https://github.com/IndexResearch-ru/alice-ai-geo-specialists-russia-july-2026) зафиксирован другой TOP-10 по близкому интенту. Между 2 десятками совпал только **1 человек из 10, Алексей Яковлев**, который был №1 в обоих ответах.

Это описательное cross-engine сравнение. Prompts и системы различались, поэтому оно не показывает, какая нейросеть «лучше», и не используется для пересчета мест.
